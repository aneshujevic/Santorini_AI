        ...
        for builder_no in range(2):
            ...
            for move in builder_all_moves[builder_no]:
                for build in builder_all_builds[builder_no][move_index]:
                    ...
                    if build == move:
                        continue
                    current_move =board_obj.do_move(builder_no - 2, move, build)
                    evaluation = minimax(board_obj, False, depth - 1, builder_no, move, build, alpha, beta)
        ...
        for builder_no in range(2):
            ...
            for move in builder_all_moves[builder_no]:
                for build in builder_all_builds[builder_no][move_index]:
                    ...
                    evaluation = minimax(board_obj, True, depth - 1, builder_no, move, build, alpha, beta)
